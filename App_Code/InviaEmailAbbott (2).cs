...
/// </summary>
public class InviaEmailAbbott2
{
    public InviaEmailAbbott2()
    {
        //
    ...
    public Boolean sendMail(string from, string to, string cc, string bcc, string Subject, string Body)
    {
        ...
        SmtpClient client = new SmtpClient("smtp.aruba.it", 25);                                               //("smtps.aruba.it", 465);
        System.Net.NetworkCredential basicCredential1 = new
        //System.Net.NetworkCredential("fullcro@gmail.com", "vpgwegdvymecfgwi");
        System.Net.NetworkCredential("adri.shallvari@fullcro.org", "adri_1966");
