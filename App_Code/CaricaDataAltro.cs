...
/// </summary>
public class CaricaDataAltro
{
    public CaricaDataAltro()
	{
		//
    ...
    public void getCaricaDataAltro(FormView fv, string strData,int limiteInf)
    {
        ...
        lst15.Text = "UK";
        lst15.Value = "UK";
        anno.Items.Add(lst15);
        for (int i = DateTime.Now.Year; i >= limiteInf; i--)
        {
